...
const projects = [
  {
    id: 1,
    title: 'Diary Notes',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum condimentum diam nec erat volutpat.',
...
window.addEventListener('DOMContentLoaded', () => {
  const fadeInElements = document.querySelectorAll('.section-title, .project-card, .profile-card, .about-content');
